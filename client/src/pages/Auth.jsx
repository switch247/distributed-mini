...
function Auth() {
    ...
    const handleSignup = (e) => {
        ...
        toggle(false)
        dispatch(signUp({ firstname: fname, lastname: lname, username: email, password: password }, navigate))
    };
            ...
            <Components.Container>
                <Components.SignUpContainer signIn={signIn}>
                    <Components.Form>
                        ...
                        <Components.Input type='text' placeholder='FirstName' ref={fnameRef} />
                        <Components.Input type='text' placeholder='LastName' ref={lnameRef} />
